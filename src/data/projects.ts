...
export const localizedProjects: Record<ProjectLocale, Project[]> = {
  ...
  en: [
    ...
    },
    {
      ...
      problem:
        "The broker app did not segment information the way we needed, and tracking prices, movements, dividends, and ownership in Excel had become inefficient.",
      solution:
        "I am building a Django dashboard where each participant signs in to see only their own data while the system organizes movements, users, and PDF statement parsing.",
      result:
